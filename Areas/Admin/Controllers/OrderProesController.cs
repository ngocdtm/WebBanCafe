...
namespace WebsiteBanCaPhe.Areas.Admin.Controllers
{
    public class OrderProesController : Controller
    {
        ...
        {
            ViewBag.IDCus = new SelectList(db.Customers, "IDCus", "NameCus","PhoneCus");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,DateOrder,IDCus,AddressDeliverry,IDVoucher,IDPay,TotalPrice")] OrderPro orderPro)
        {
