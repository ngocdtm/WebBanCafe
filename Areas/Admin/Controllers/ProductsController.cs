...
namespace WebsiteBanCaPhe.Areas.Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,NamePro,DecriptionPro,Category,Price,ImagePro,Amount")] Product product, HttpPostedFileBase ImagePro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,NamePro,DecriptionPro,Category,Price,ImagePro,Amount")] Product product, HttpPostedFileBase ImagePro)
        {
            if (ModelState.IsValid)
            {
